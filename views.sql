...
syngap.sasa_average AS `sasa_average`,
syngap.sasa_delta AS `sasa_delta`,
syngap.Bfactor_backbone_delta AS `Bfactor_backbone_delta`,
syngap.Bfactor_backbone_stddev AS `Bfactor_backbone_stddev`,
syngap.Bfactor_sidechain_delta AS `Bfactor_sidechain_delta`,
syngap.Bfactor_sidechain_stddev AS `Bfactor_sidechain_stddev`,
...
syngap.SA_Secondary AS `SA_Secondary`,
syngap.SA_Tertiary AS `SA_Tertiary`,
syngap.SA_Buried AS `SA_Buried`,
syngap.SA_GAP_Ras_interface AS `SA_GAP_Ras_interface`,
syngap.SA_Membrane_interface AS `SA_Membrane interface`,
syngap.SA_Benign AS `SA_Benign`,
syngap.Alert AS `Alert`,
syngap.verdictID AS `verdictID`,
syngap_verdict.verdict AS `verdict`,
syngap.description AS `description`,
...
LEFT JOIN syngap_verdict ON `syngap`.`verdictID` = `syngap_verdict`.`verdictID`
LEFT JOIN syngap_structural ON syngap.variant = syngap_structural.variant;
...
syngap.sasa_average AS `average SASA`,
syngap.sasa_delta AS `dSASA`,
syngap.Bfactor_backbone_delta AS `d B-factor backbone`,
syngap.Bfactor_backbone_stddev AS `StdDev B-factor backbone`,
syngap.Bfactor_sidechain_delta AS `d B-factor sidechain`,
syngap.Bfactor_sidechain_stddev AS `StdDev B-factor sidechain`,
syngap.SA_Secondary AS `SA Secondary`,
syngap.SA_Tertiary AS `SA Tertiary bonds`,
syngap.SA_Buried AS `SA Inside out`,
syngap.SA_GAP_Ras_interface AS `SA GAP-Ras interface`,
syngap.SA_Membrane_interface AS `SA At membrane`,
syngap.SA_Benign AS `SA No effect`,
syngap.Alert AS `SA MD Alert`,
syngap_verdict.verdict AS `SA Verdict`,
syngap.description AS `SA Description`,
syngap.doi AS `DOI`
FROM cdna
LEFT JOIN syngap  ON cdna.variant  = syngap.variant
LEFT JOIN syngap_domain ON `syngap`.`domainID` = `syngap_domain`.`domainID`
